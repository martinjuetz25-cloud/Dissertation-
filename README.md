...
[media/17181951643561/image7.emf]
...
### 4.2.3 Univariate Analysen zur Identifizierung weitere prognostische Parameter
...
Zuvor haben wir und andere gezeigt, dass der HPV-Infektionsstatus ein starker Prognostiker für die lokoregionale Kontrolle bei Patienten mit lokal fortgeschrittenem HNSCC ist, die eine postoperative Radio(Chemotherapie (6, 28, **[29]**) mit einer verbesserten lokoregionalen Kontrolle und Radioempfindlichkeit von HPV16 DNA-positiv im Vergleich zu HPV16 DNA-negativen Tumoren erhielten. In unserer vorherigen multizentrischen Bewertung fanden wir praktisch keine Rezidiven in der HPV16-DNA-positiven Gruppe bei Hochrisiko-HNSCC-Patienten, die PORT-C (6) erhielten. Patienten in dieser sehr vorteilhaften Gruppe können daher Kandidaten für potenzielle Strahlentherapie-Deeskalationsstudien sein. Für die weitere Schichtung von Patienten mit HPV-negativem HNSCC sind jedoch zusätzliche Biomarker erforderlich, um eine lokoregionale Kontrolle vorherzusagen, um zusätzliche Patienten zu identifizieren, die der sehr guten Prognosegruppe zugeordnet werden könnten, und um eine Patientengruppe mit sehr ungünstigem Ergebnis zu definieren, die ein Kandidat für Behandlungsverstärkungsstrategien sein
...
# 6 Erklärungen zur Eröffnung des Promotionsverfahrens
...
3. Ich bestätige, dass ich die Promotionsordnung der Medizinischen Fakultät der Technischen Uni- versität Dresden anerkenne.([Jütz et al., 2015])
...
Ich habe promoviert zum Thema: "Das prognostische Potential von CD44 als Tumorstammzellmarker für die kombinierte Radiochemotherapie des lokal fortgeschrittenen Kopf-Hals-Plattenepithelkarzinoms."

In meiner Dissertation untersuchte ich, inwieweit CD44 als Tumorstammzellmarker eine prognostische Rolle bei Patienten mit lokal fortgeschrittenem Kopf-Hals-Plattenepithelkarzinom, die nach ihrer Primärchirurgie eine postoperative Radiochemotherapie erhielten, spielen kann. Patienten mit dieser Erkrankung weisen oft trotz ähnlicher Tumorcharakteristika und vergleichbarem Behandlungsansatz sehr unterschiedliche klinische Verläufe in Bezug auf Überleben, Metastasierung und Therapieansprechen auf. Es war daher notwendig, geeignete biologische Marker zur besseren Prognoseschätzung und Therapieoptimierung zu identifizieren.

Diese Arbeit war Teil einer multizentrischen Studie des Deutschen Konsortiums für Translationale Krebsforschung (DKTK-ROG). Insgesamt wurden 221 Patienten an acht DKTK-Standorten in die Studie eingeschlossen. Das Gewebe von 195 primären Tumoren wurde mittels immunhistochemischer Färbung auf CD44-Proteinexpression untersucht. Anschließend erfolgte die Korrelation der CD44-Expression mit klinischen Endpunkten wie loco-regionaler Tumorkontrolle, Fernmetastasen-freiem Überleben und Gesamtüberleben.

Die Ergebnisse zeigten eine signifikante Assoziation der CD44-Expression mit einer schlechten loco-regionalen Kontrolle (p = 0,008), nicht jedoch mit den sekundären Endpunkten Fernmetastasen-freies Überleben (p = 0,075) oder Gesamtüberleben (p = 0,089). Besonders in der Subgruppe der HPV16-DNA-negativen Tumoren wies eine hohe CD44-Expression auf eine schlechtere loco-regionale Tumorkontrolle hin (p = 0,05).

Zusammenfassend konnte gezeigt werden, dass eine Überexpression von CD44 eine Rolle als negativer prognostischer Marker bei lokal fortgeschrittenen Kopf-Hals-Plattenepithelkarzinomen nach postoperativer Radiochemotherapie spielt. Diese Erkenntnis kann dazu beitragen, zukünftig eine individuellere und optimierte Therapieplanung für Patienten durchzuführen. Die Ergebnisse bedürfen einer weiteren Validierung in prospektiven Studien unter standardisierten Bedingungen, um ihre klinische Anwendbarkeit zu bestätigen.

/

In meiner Dissertation untersuchte ich das prognostische Potential des Tumorstammzellmarkers CD44 bei Patienten mit lokal fortgeschrittenem Kopf-Hals-Plattenepithelkarzinom, die nach ihrer Primärchirurgie eine postoperative Radiochemotherapie erhielten. Die Ergebnisse zeigten, dass eine hohe CD44-Expression mit einer schlechteren loco-regionalen Tumorkontrolle assoziiert ist, insbesondere bei HPV16-DNA-negativen Tumoren, was auf die Möglichkeit einer individuelleren Therapieplanung hinweist.
